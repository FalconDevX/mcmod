...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> CABINET = registerBlockWithoutItem("cabinet",
            () -> new CabinetBlock(
    ...
    //register block without automatic BlockItem
